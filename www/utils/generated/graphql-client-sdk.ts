...
orders_with_billing_address_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["order_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["order_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["order_bool_exp"]},ValueTypes["order_aggregate"]],
orders_with_shipping_address?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["order_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["order_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["order_bool_exp"]},ValueTypes["order"]],
orders_with_shipping_address_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["order_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["order_order_by"][],	/** filter the rows returned */
...
count?: [{	columns?:ValueTypes["address_select_column"][],	distinct?:boolean},true],
...
delete_product_category_enum?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["product_category_enum_bool_exp"]},ValueTypes["product_category_enum_mutation_response"]],
delete_product_category_enum_by_pk?: [{	name:string},ValueTypes["product_category_enum"]],
delete_product_review?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["product_review_bool_exp"]},ValueTypes["product_review_mutation_response"]],
delete_product_review_by_pk?: [{	id:number},ValueTypes["product_review"]],
delete_site_admin?: [{	/** filter the rows which have to be deleted */
...
insert_address?: [{	/** the rows to be inserted */
	...
	on_conflict?:ValueTypes["address_on_conflict"]},ValueTypes["address_mutation_response"]],
insert_address_one?: [{	/** the row to be inserted */
	object:ValueTypes["address_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["address_on_conflict"]},ValueTypes["address"]],
insert_order?: [{	/** the rows to be inserted */
	objects:ValueTypes["order_insert_input"][],	/** on conflict condition */
	on_conflict?:ValueTypes["order_on_conflict"]},ValueTypes["order_mutation_response"]],
insert_order_one?: [{	/** the row to be inserted */
	object:ValueTypes["order_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["order_on_conflict"]},ValueTypes["order"]],
insert_order_product?: [{	/** the rows to be inserted */
	objects:ValueTypes["order_product_insert_input"][],	/** on conflict condition */
	on_conflict?:ValueTypes["order_product_on_conflict"]},ValueTypes["order_product_mutation_response"]],
...
insert_product_category_enum?: [{	/** the rows to be inserted */
	objects:ValueTypes["product_category_enum_insert_input"][],	/** on conflict condition */
	on_conflict?:ValueTypes["product_category_enum_on_conflict"]},ValueTypes["product_category_enum_mutation_response"]],
insert_product_category_enum_one?: [{	/** the row to be inserted */
	object:ValueTypes["product_category_enum_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["product_category_enum_on_conflict"]},ValueTypes["product_category_enum"]],
insert_product_one?: [{	/** the row to be inserted */
	object:ValueTypes["product_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["product_on_conflict"]},ValueTypes["product"]],
insert_product_review?: [{	/** the rows to be inserted */
	objects:ValueTypes["product_review_insert_input"][],	/** on conflict condition */
	on_conflict?:ValueTypes["product_review_on_conflict"]},ValueTypes["product_review_mutation_response"]],
insert_product_review_one?: [{	/** the row to be inserted */
	object:ValueTypes["product_review_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["product_review_on_conflict"]},ValueTypes["product_review"]],
insert_site_admin?: [{	/** the rows to be inserted */
	objects:ValueTypes["site_admin_insert_input"][],	/** on conflict condition */
	on_conflict?:ValueTypes["site_admin_on_conflict"]},ValueTypes["site_admin_mutation_response"]],
insert_site_admin_one?: [{	/** the row to be inserted */
	object:ValueTypes["site_admin_insert_input"],	/** on conflict condition */
	on_conflict?:ValueTypes["site_admin_on_conflict"]},ValueTypes["site_admin"]],
...
the end). throws an error if top level container is not an array */
	...
	where:ValueTypes["product_bool_exp"]},ValueTypes["product_mutation_response"]],
update_product_by_pk?: [{	/** append existing jsonb value of filtered columns with new jsonb value */
	_append?:ValueTypes["product_append_input"],	/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
	_delete_at_path?:ValueTypes["product_delete_at_path_input"],	/** delete the array element with specified index (negative integers count from
the end). throws an error if top level container is not an array */
	_delete_elem?:ValueTypes["product_delete_elem_input"],	/** delete key/value pair or string element. key/value pairs are matched based on their key value */
...
update_product_category_enum?: [{	/** sets the columns of the filtered rows to the given values */
...
products?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["order_product_bool_exp"]},ValueTypes["order_product"]],
...
count?: [{	columns?:ValueTypes["order_select_column"][],	distinct?:boolean},true],
...
count?: [{	columns?:ValueTypes["order_product_select_column"][],	distinct?:boolean},true],
...
orders_aggregate?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["order_product_bool_exp"]},ValueTypes["order_product_aggregate"]],
	price?:true,
product_reviews?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["product_review_bool_exp"]},ValueTypes["product_review"]],
product_reviews_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["product_review_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["product_review_order_by"][],	/** filter the rows returned */
...
count?: [{	columns?:ValueTypes["product_select_column"][],	distinct?:boolean},true],
...
products?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["product_bool_exp"]},ValueTypes["product"]],
products_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["product_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["product_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["product_bool_exp"]},ValueTypes["product_aggregate"]],
		__typename?: true
}>;
...
count?: [{	columns?:ValueTypes["product_category_enum_select_column"][],	distinct?:boolean},true],
...
count?: [{	columns?:ValueTypes["product_review_select_column"][],	distinct?:boolean},true],
...
address?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["address_bool_exp"]},ValueTypes["address"]],
...
order_product?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["order_product_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["order_product_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["order_product_bool_exp"]},ValueTypes["order_product"]],
order_product_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["order_product_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["order_product_order_by"][],	/** filter the rows returned */
...
product_category_enum?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["product_category_enum_bool_exp"]},ValueTypes["product_category_enum"]],
product_category_enum_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["product_category_enum_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["product_category_enum_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["product_category_enum_bool_exp"]},ValueTypes["product_category_enum_aggregate"]],
product_category_enum_by_pk?: [{	name:string},ValueTypes["product_category_enum"]],
product_review?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["product_review_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["product_review_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["product_review_bool_exp"]},ValueTypes["product_review"]],
product_review_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["product_review_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["product_review_order_by"][],	/** filter the rows returned */
...
site_admin?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["site_admin_bool_exp"]},ValueTypes["site_admin"]],
site_admin_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["site_admin_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["site_admin_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["site_admin_bool_exp"]},ValueTypes["site_admin_aggregate"]],
...
count?: [{	columns?:ValueTypes["site_admin_select_column"][],	distinct?:boolean},true],
...
["user"]: AliasType<{
addresses?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["address_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["address_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["address_bool_exp"]},ValueTypes["address"]],
addresses_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["address_select_column"][],	/** limit the number of rows returned */
	limit?:number,	/** skip the first n rows. Use only with order_by */
	offset?:number,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["address_order_by"][],	/** filter the rows returned */
